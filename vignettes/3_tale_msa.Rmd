...
But right now what we need is a mapping between distal parts IDs and the cognate RVDs. This can be done in a number of ways but let's use the one below that relies on `getRepeat2RvdMapping()`.
